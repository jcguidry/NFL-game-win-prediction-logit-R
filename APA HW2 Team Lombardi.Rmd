---
title: "Applied Predictive Analytics NFL Game Outcome Prediction"
author: "Team Lombardi"
date: "12/1/2021"
output: pdf_document
header-includes:
   - \usepackage{setspace}
...
write.csv(df,"pre_model_data.csv", row.names = FALSE)
...
# if all the libraries are imported, AND you've run the above cell at least once, you can now begin running from here to prevent redundant calculations

#######

df = read.csv("pre_model_data.csv")
...
write.csv(df,"hw2_data_with_predictions.csv", row.names = FALSE)
